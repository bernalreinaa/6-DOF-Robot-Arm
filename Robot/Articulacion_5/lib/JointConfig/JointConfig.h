...
constexpr float ratio = 4.57866666f;        // Reductora articulación 5
constexpr int   driverMicrosteps = 1;
...
// Zona prohibida entre 180° y 310°.
constexpr double limitInfDeg = 180.0;
constexpr double limitSupDeg = 310.0;
...
constexpr float cruiseVelDegS   = 300.0f;
constexpr float approachVelDegS = 250.0f;
constexpr float minVelDegS      = 200.0f;

constexpr float tolDeg          = 0.15f;
constexpr float slowZoneDeg     = 2.0f;
constexpr float approachZoneDeg = 5.0f;
